...
public class MainActivityTest extends ScreenshotTest {
    ...
    @Test
    public void doesNotShowEmptyCaseIfThereAreAnySuperHero() throws Exception {
    ...
    @Test
    public void showSuperHeroesListIfThereAreMoreThanOneSuperHero() throws Exception {
    ...
    @Test
    public void showSuperHeroesListIfThereAreTenSuperHero() throws Exception {
